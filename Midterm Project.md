...
<li>
<p>This exercise uses the <a href="https://www.lock5stat.com/datasets4e/BodyFat.csv">sample data</a> here.  We will consider bodyfat to be the response variable.<br>
